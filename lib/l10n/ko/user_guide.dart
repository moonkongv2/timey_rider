...
class UserGuideTexts implements UserGuideTextSet {
  ...
  String get subtitle => '활동 미션, 응원 영상, 차량 스티커 규칙을 확인해요.';
  ...
  List<String> get courseMarkersItems => const [
    ...
    '마커는 완료 여부나 차량 스티커 판정을 직접 결정하지 않아요.',
  ];
  ...
  String get completionTitle => '완료와 차량 스티커';
  List<String> get completionItems => const [
    '활동을 마쳤다고 확인하면 완료로 기록돼요.',
    '시간이 끝난 뒤에도 아이와 함께 확인하고 차량 스티커를 받을지 선택해요.',
    '차량 스티커 받기를 선택하면 선택한 차량 스티커를 받아요.',
    '이번엔 차량 스티커 받지 않기를 선택하면 기록만 남기고 다음 조절에 참고해요.',
  ...
  List<String> get historyRewardsItems => const [
    ...
    '받은 차량 스티커와 직접 고른 그림 마커도 함께 확인할 수 있어요.',
  ...
  List<String> get guardianTipsItems => const [
    '아이에게 차량 스티커보다 루틴을 시도한 점을 먼저 칭찬해 주세요.',
